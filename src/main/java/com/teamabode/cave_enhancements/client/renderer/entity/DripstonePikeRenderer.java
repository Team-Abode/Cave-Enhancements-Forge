...
public class DripstonePikeRenderer extends MobRenderer<DripstonePike, DripstonePikeModel<DripstonePike>> {
    ...
    public static final ResourceLocation TEXTURE = new ResourceLocation(CaveEnhancements.MOD_ID, "textures/entity/dripstone_tortoise/dripstone_pike.png");

    public DripstonePikeRenderer(EntityRendererProvider.Context context) {
        super(context, new DripstonePikeModel<>(context.bakeLayer(DripstonePikeModel.ENTITY_MODEL_LAYER)), 0.0f);
    }
