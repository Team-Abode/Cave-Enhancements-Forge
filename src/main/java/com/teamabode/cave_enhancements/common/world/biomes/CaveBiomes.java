package com.teamabode.cave_enhancements.common.world.biomes;
...
public class CaveBiomes {
    ...
    private static void roseQuartzFeatures(BiomeGenerationSettings.Builder builder) {
        ...
        builder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModFeatures.ModPlacedFeatures.ROSE_QUARTZ_PILLAR_FLOOR_PATCH.getHolder().get());
        builder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModFeatures.ModPlacedFeatures.ROSE_QUARTZ_PILLAR_CEILING_PATCH.getHolder().get());
    }
    ...
    public static Biome goopCaves() {
        ...
        spawnSettings.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(ModEntities.GOOP.get(), 80, 1, 1));
