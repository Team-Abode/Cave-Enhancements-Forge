package com.kekecreations.cave_enhancements.entity.dripstone_tortoise;

import com.kekecreations.cave_enhancements.entity.dripstone_tortoise.goals.DripstoneTortoiseHurtByTargetGoal;
import com.kekecreations.cave_enhancements.entity.dripstone_tortoise.goals.DripstoneTortoiseRandomSpikeGoal;
import com.kekecreations.cave_enhancements.entity.dripstone_tortoise.goals.DripstoneTortoiseSpikeAttackGoal;
...
public class DripstoneTortoise extends PathfinderMob implements NeutralMob {
    ...
    public void summonPike(Vec3 pos){
        ...
        DripstonePike dripstonePike = new DripstonePike(ModEntities.DRIPSTONE_PIKE.get(), level);
